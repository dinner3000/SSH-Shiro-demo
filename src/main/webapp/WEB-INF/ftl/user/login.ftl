...
<html lang="zh-cn">
    ...
    <body id="body">
        ...
        <iframe id="hidden" src="http://www.demo1.com:8080/shiro.demo/html/hidden.html" width="0px" height="0px"></iframe>
        <!-- Javascript -->
        ...
        <script  src="${basePath}/js/common/jquery/jquery.cookie.js"></script>
		<script src="${basePath}/MessengerJS/messenger.js"></script>
        <script >
			jQuery(document).ready(function() {
                ...
                var messenger = new Messenger('parent', 'BRHID');
                var hidden = document.getElementById('hidden');
                messenger.addTarget(hidden.contentWindow, 'hidden');
			        ...
			        $.ajax({
			        	...
			        	success:function(result){
				    		...
				    		if(result && result.status != 200){
				    			...
				    			layer.msg('登录成功！');
                                var brhid = $.cookie("BRHID");
                                messenger.targets["hidden"].send(brhid);
